	...
	return map[string]interface{}{
		"content": map[string]interface{}{
			"classes": []map[string]interface{}{
				...
				{
					consts.NAME:   "EntityAuthSettings",
					consts.UUID:   "META_ENTITY_AUTH_SETTINGS_UUID",
					"innerId":     4,
					"root":        true,
					consts.SYSTEM: true,
					"attributes": []map[string]interface{}{
						{
							consts.NAME:   "id",
							consts.TYPE:   "ID",
							consts.UUID:   "RX_ENTITY_AUTH_SETTINGS_ID_UUID",
							"primary":     true,
							"typeLabel":   "ID",
							consts.SYSTEM: true,
						},
						{
							consts.NAME:   "entityUuid",
							consts.TYPE:   "String",
							consts.UUID:   "RX_ENTITY_AUTH_SETTINGS_ENTITY_UUID_UUID",
							"typeLabel":   "String",
							consts.SYSTEM: true,
						},
						{
							consts.NAME:   "expand",
							consts.TYPE:   "Boolean",
							consts.UUID:   "RX_ENTITY_AUTH_SETTINGS_EXPAND_UUID",
							"typeLabel":   "Boolean",
							consts.SYSTEM: true,
						},
					},
					...
					"attributes": []map[string]interface{}{
						{
							consts.NAME:   "id",
							consts.TYPE:   "ID",
							consts.UUID:   "RX_ABILITY_ID_UUID",
							"primary":     true,
							"typeLabel":   "ID",
							consts.SYSTEM: true,
						},
						{
							consts.NAME:   "entityUuid",
							consts.TYPE:   "String",
							consts.UUID:   "RX_ABILITY_ENTITY_UUID_UUID",
							"typeLabel":   "String",
							consts.SYSTEM: true,
						},
						{
							consts.NAME:   "columnUuid",
							consts.TYPE:   "String",
							consts.UUID:   "RX_ABILITY_COLUMN_UUID_UUID",
							"typeLabel":   "String",
							consts.SYSTEM: true,
						},
						{
							consts.NAME:   "can",
							consts.TYPE:   "Boolean",
							consts.UUID:   "RX_ABILITY_CAN_UUID",
							"typeLabel":   "Boolean",
							consts.SYSTEM: true,
						},
						{
							consts.NAME:   "expression",
							consts.TYPE:   "String",
							consts.UUID:   "RX_ABILITY_EXPRESSION_UUID",
							"typeLabel":   "String",
							"length":      2000,
							consts.SYSTEM: true,
						},
